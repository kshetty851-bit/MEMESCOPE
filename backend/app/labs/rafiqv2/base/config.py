...
# From the Rafiq Lab's outcomes module, which went with that lab.

#: How long a closed trade's token is watched before the learning layer hears
#: about the trade: an hour, measured from the exit.
