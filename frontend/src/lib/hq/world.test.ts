...
describe("the expanded floor plan", () => {
  it("expanded the grid without moving anything that existed", () => {
    ...
    // 17 for the Rafiq Analytics wing (2026-09-10), 14 again since it went
    // (2026-09-25). Rows rather than columns because
    // GRID_ROWS drives X_ORIGIN, so changing them shifts the whole room as one
